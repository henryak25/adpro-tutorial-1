...
class CreateProductFunctionalTest {
    ...
    void createProduct_isCorrect(ChromeDriver driver) throws Exception{
        ...
        WebElement productQuantityInput = driver.findElement(By.id("quantityInput"));
        WebElement submitButton = driver.findElement(By.cssSelector("button[type='submit']"));
        productNameInput.sendKeys("Nasi Goreng");
        ...
        WebElement productNameOnWebsite = driver.findElement(By.xpath("//td[contains(text(),'Nasi Goreng')]"));
        WebElement productQuantityOnWebsite = driver.findElement(By.xpath("//td[contains(text(),'5')]"));
